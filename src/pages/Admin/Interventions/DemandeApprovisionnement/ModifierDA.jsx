...
function AjouterDemandeApprovisionnement() {
    ...
    useEffect(() => {
        fetch('http://localhost:4000/demandes')
            .then((response) => response.json())
            .then((data) => {
                const demande = data.find(item => item.id === id);
                if (demande) {
                    setFormData({
                        qte: demande.qte || '',
                        unite: demande.unite || '',
        ...
        <>
            ...
            <div className="container_header_cat">
                <div className="container_header_right">
                    <h1 className="container_title">Modifier un demande d'approvisionnement</h1>
                    <p className="container_subtitle">
                        complétez le formulaire pour modifier un demande d'approvisonnement d'un intervention
                    </p>
